...
// from the dirty map.
var globalExpunged = unsafe.Pointer(new(interface{}))
...
func createEntry(i interface{}) *entry {
...
func (e *entry) unexpungeLocked() (wasExpunged bool) {
	return atomic.CompareAndSwapPointer(&e.p, globalExpunged, nil)
}
...
func (e *entry) tryExpungeLocked() (isExpunged bool) {
	p := atomic.LoadPointer(&e.p)
	for p == nil {
		if atomic.CompareAndSwapPointer(&e.p, nil, globalExpunged) {
			return true
		}
		p = atomic.LoadPointer(&e.p)
	}
	return p == globalExpunged
}
